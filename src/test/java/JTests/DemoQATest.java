...
public class DemoQATest extends BaseTest {
    ...
    public void testFormFill() {
        ...
        File picture = new File("src/testpic.jpg");
        String picName = picture.getName(); // Имя файла изображения для проверки в результатах
        ...
        formPage.selectPictureFile(picture.getAbsolutePath());
